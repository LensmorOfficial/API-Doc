...
| Live endpoint inventory | 15 live endpoints across 5 controller families | Same 15 live endpoints are listed under the implemented-now summary | Aligned | Draft-only routes are excluded from the live inventory |
