...
- List results do not include attendee or personnel counts; use [Event details](/api-reference/events/detail) or [Event brief](/api-reference/events/brief) when you need scale fields for one event.
