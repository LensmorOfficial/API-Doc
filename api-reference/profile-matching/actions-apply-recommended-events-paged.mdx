...
Apply profile-matching input and return paged event recommendations.

Use this endpoint when you want to submit company or audience context and receive filtered recommended events in one synchronous request.
...
## Notes
- This is the preferred endpoint for synchronous profile matching apply requests.
