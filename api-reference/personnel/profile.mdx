...
Use this endpoint when you already know the personnel identifier and need the public profile shape for that person.
...
## Notes
- The public contract stays lightweight.
