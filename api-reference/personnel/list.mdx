...
## Notes
- Personnel list responses intentionally use the lightweight contact-style public shape, but now include user-scoped `email` and `contactUnlockStatus`.
...
- `title` is sourced from the event-personnel relation `jobTitle`.
