...
Lensmor provides access to the public API endpoints exposed under `https://platform.lensmor.com/external/*`.
...
It focuses on the request and response behavior needed to integrate with Lensmor.
