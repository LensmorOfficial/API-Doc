...
description: "List Lensmor events related to a person or personnel record, including event metadata, location fields, dates, and pagination context."
openapi: "openapi.json GET /external/personnel/events"
---
...
If your starting point is a LinkedIn URL rather than a Lensmor personnel ID, use [Personnel events by LinkedIn](/api-reference/personnel/list-personnel-related-events-by-linkedin-url).
