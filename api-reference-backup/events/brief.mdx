...
openapi: "openapi.json GET /external/events/brief"
---
...
Prefer [Event detail](/api-reference/events/get-event-detail) when your product needs category, topic, pricing, coordinate, or historical metadata.
