...
openapi: "openapi.json GET /external/events/{id}"
---
...
- [List event exhibitors](/api-reference/exhibitors/list-event-exhibitors) for exhibitor totals.
- [List event personnel](/api-reference/personnel/list-event-personnel) for personnel totals.
...
## Notes
- For event identifiers, see [Identifiers](/concepts/identifiers). `id` and `eventId` are separate values and can differ.
