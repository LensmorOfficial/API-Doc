...
openapi: "openapi.json POST /external/exhibitors/search"
---
...
If you already know the exact company name and want a precision-first lookup, use [Search exhibitors by company name](/api-reference/exhibitors/search-exhibitors-by-company-name). If you need events directly from a company name, use [Search exhibitor events](/api-reference/exhibitors/search-events-by-exhibitor-company-name).
