...
If you only have a company name, use [Exhibitor event search](/api-reference/exhibitors/search-events). If you need the company profile first, use [Exhibitor profile details](/api-reference/exhibitors/profile).
